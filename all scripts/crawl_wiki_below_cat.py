...
def scrap_url(rel_add,parent=None,lvl=0,pdomain=domain):
    ...
    cat_sec = soup.find(id="mw-normal-catlinks")

    if cat_sec is not None:
        anchors = cat_sec.find_all('a')
        # print(anchors)
        for anchor in anchors:
            if anchor.text == "Categories":
                continue
...
# pickle_file.close()
# print("pickled")
# pickle_file = open("root_tree_lvl2.pickle","rb")
